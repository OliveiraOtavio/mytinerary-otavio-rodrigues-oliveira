...
export default function SocialIcons() {
  return (
    <div className="w-[30vw] h-[3.5em] flex items-center justify-start gap-[0.3em]">
      <p
        className="hidden text-white font-semibold  bg-gray-900  rounded flex items-center justify-center
                   md:hidden
                   lg:flex lg:w-[7em] lg:h-[2.7em]"
      >
        Social Media
      </p>
      {icons.map((icon) => (
